...
export function NursePortal({ onSignOut }: { onSignOut: () => void }) {
  ...
  const [medicationScheduleList, setMedicationScheduleList] = useState([
    { patient: 'John Smith', medication: 'Lisinopril 10mg', time: '09:00 AM', status: 'given', prescribedBy: 'Dr. Johnson' },
    { patient: 'Emma Davis', medication: 'Amoxicillin 500mg', time: '10:00 AM', status: 'pending', prescribedBy: 'Dr. Chen' },
    { patient: 'Robert Wilson', medication: 'Insulin 10 units', time: '11:00 AM', status: 'pending', prescribedBy: 'Dr. Brown' },
    { patient: 'Lisa Anderson', medication: 'Metformin 850mg', time: '12:00 PM', status: 'scheduled', prescribedBy: 'Dr. White' }
  ]);
  ...
  const nurseProfile = {
    ...
    certifications: ['RN License', 'BLS', 'ACLS', 'Critical Care']
  };
  ...
  const selectedPatientData = {
    ...
    medicalHistory: [
      { condition: 'Hypertension', diagnosed: '2019', status: 'Ongoing' },
    ...
    recentVisits: [
      { date: '2024-11-10', doctor: 'Dr. Johnson', reason: 'Regular checkup' },
      { date: '2024-10-15', doctor: 'Dr. Chen', reason: 'Blood pressure monitoring' }
    ]
  };

  const todayPatients = [
    { id: 1, name: 'John Smith', room: '101', condition: 'Hypertension' },
    { id: 2, name: 'Emma Davis', room: '102', condition: 'Post-surgery' },
    { id: 3, name: 'Robert Wilson', room: '103', condition: 'Diabetes monitoring' },
    { id: 4, name: 'Lisa Anderson', room: '104', condition: 'Pneumonia' }
  ];

  const patientsData: { [key: number]: any } = {
    1: {
      name: 'John Smith',
      age: 58,
      gender: 'Male',
      ...
      recentVisits: [
        { date: '2024-11-10', doctor: 'Dr. Johnson', reason: 'Regular checkup' },
        { date: '2024-10-15', doctor: 'Dr. Johnson', reason: 'Blood pressure monitoring' }
      ]
    },
    2: {
      name: 'Emma Davis',
      ...
      allergies: ['Latex'],
      medicalHistory: [
        { condition: 'Appendectomy', diagnosed: '2024', status: 'Recent Surgery' }
      ],
      currentMedications: [
        { name: 'Amoxicillin', dosage: '500mg', frequency: 'Three times daily' },
        { name: 'Pain Relief', dosage: '400mg', frequency: 'As needed' }
      ],
      recentVisits: [
        { date: '2024-11-15', doctor: 'Dr. Chen', reason: 'Post-surgery checkup' },
        { date: '2024-11-12', doctor: 'Dr. Chen', reason: 'Surgery' }
      ]
    },
    3: {
      name: 'Robert Wilson',
      ...
      medicalHistory: [
        { condition: 'Type 2 Diabetes', diagnosed: '2018', status: 'Ongoing' },
        { condition: 'High Cholesterol', diagnosed: '2019', status: 'Controlled' }
      ],
      currentMedications: [
      ...
      recentVisits: [
        { date: '2024-11-14', doctor: 'Dr. Brown', reason: 'Diabetes monitoring' },
        { date: '2024-10-28', doctor: 'Dr. Brown', reason: 'Regular checkup' }
      ]
    },
    4: {
      name: 'Lisa Anderson',
      ...
      medicalHistory: [
        { condition: 'Pneumonia', diagnosed: '2024', status: 'Active Treatment' },
        { condition: 'Asthma', diagnosed: '2015', status: 'Controlled' }
      ],
      currentMedications: [
      ...
      recentVisits: [
        { date: '2024-11-16', doctor: 'Dr. White', reason: 'Pneumonia treatment' },
        { date: '2024-11-13', doctor: 'Dr. White', reason: 'Initial diagnosis' }
      ]
    }
  };

  const vitalHistory = [
    { date: '2024-11-16 09:00', bp: '120/80', temp: '98.6°F', pulse: '72', spo2: '98%' },
    { date: '2024-11-16 06:00', bp: '118/78', temp: '98.4°F', pulse: '70', spo2: '99%' },
    { date: '2024-11-15 21:00', bp: '122/82', temp: '98.7°F', pulse: '74', spo2: '97%' }
  ];
